...
import {
  CheckCircle, X, GitCommit, ArrowRight, RefreshCw, Trophy
} from "lucide-react";
...
const levels: Level[] = [
  { 
    id: 1, 
    code: "x = a + b\ny = x * c",
    question: "How many basic blocks?",
    options: ["1", "2", "3"], 
    correct: 0 
  },
  { 
  ...
  { 
    id: 3, 
    code: "while (i < n):\n  sum += i",
    question: "Where does the loop back edge go?",
    options: ["To header", "To exit", "Nowhere"], 
    correct: 0 
  },
];

export default function IRMinigameEnhanced() {
      ...
      <div className="p-4 border-b border-[#30363d] bg-[#161b22]">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <GitCommit size={18} className="text-[#79c0ff]" />
            <span className="text-white font-medium">CFG Builder</span>
          </div>
