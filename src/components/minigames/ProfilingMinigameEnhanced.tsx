...
import {
  CheckCircle, X, BarChart2, ArrowRight, RefreshCw, Trophy
} from "lucide-react";
...
const levels: Level[] = [
  { 
    id: 1, 
    scenario: "Flame graph shows:\nfuncA: 50%\nfuncB: 30%\nfuncC: 20%",
    question: "Which to optimize first?",
    options: ["funcC", "funcB", "funcA"], 
    correct: 2 
  },
  { 
    id: 2, 
    scenario: "Sampling profiler:\nFunction runs 1ms\nTotal time: 10s\n1000 samples",
    question: "Expected samples for this function?",
    options: ["100", "10", "0 or 1"], 
    correct: 2 
  },
  { 
    id: 3, 
    scenario: "High L1 cache misses\nin a tight loop",
    question: "Likely cause?",
    options: ["Too many branches", "Strided memory access", "Too many function calls"], 
    correct: 1 
  },
];

export default function ProfilingMinigameEnhanced() {
      ...
      <div className="p-4 border-b border-[#30363d] bg-[#161b22]">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <BarChart2 size={18} className="text-[#f0883e]" />
            <span className="text-white font-medium">Performance Detective</span>
          </div>
