...
import {
  CheckCircle, X, Zap, ArrowRight, RefreshCw, Trophy
} from "lucide-react";
...
const levels: Level[] = [
  { 
    id: 1, 
    scenario: "select() with 1000 fds\nOnly 10 are ready",
    question: "How many checks?",
    options: ["10", "1000", "100"], 
    correct: 1 
  },
  { 
    id: 2, 
    scenario: "epoll() with 1000 fds\nOnly 10 are ready",
    question: "How many events returned?",
    options: ["10", "1000", "100"], 
    correct: 0 
  },
  { 
    id: 3, 
    scenario: "Thread-per-connection:\n10,000 concurrent clients",
    question: "Main issue?",
    options: ["Too many threads", "Slow I/O", "Memory leaks"], 
    correct: 0 
  },
];

export default function IOMinigameEnhanced() {
      ...
      <div className="p-4 border-b border-[#30363d] bg-[#161b22]">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Zap size={18} className="text-[#f0883e]" />
            <span className="text-white font-medium">Event Loop Challenge</span>
          </div>
